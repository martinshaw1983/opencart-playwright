...
Locator: getByRole('link', { name: 'Search' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Search' })
...
- generic [ref=e1]:
  ...
  - banner [ref=e28]:
    - generic [ref=e30]:
      ...
      - generic [ref=e36]:
        - textbox "Search" [active] [ref=e37]: Eggs
...
> 30 |     await expect(searchResultsPage.noProductsFound).toBeVisible();
     |                                                     ^ Error: expect(locator).toBeVisible() failed
  31 |     //const count = searchResultsPage.getProductCount();
